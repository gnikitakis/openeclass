...
$langAPITokenUser = 'Acts as user';
$langAPITokenUserHelp = 'Username of an existing user. Requests made with this token act with that user\'s rights, in the courses that user teaches. Leave empty for a token of the classic API only.';
$langAPITokenUserNotFound = 'No user with this username exists.';
$langAPITokenScopes = 'Permissions (Integration API)';
$langAPITokenScopesHelp = 'What the token may do. Everything the token creates stays hidden from students; a "publish" permission is needed to make content visible.';
$langAPITokenClassic = 'classic API';
$langExtAppAll = "All";
